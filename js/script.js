const translations = {
	en: {
		...
		reset_button: "Reset",
		probability_tag: "Set Winning Probability (%)",
	...
	es: {
		...
		probability_tag: "Establecer Probabilidad de Ganar (%)",
	...
	de: {
		...
		probability_tag: "Gewinnwahrscheinlichkeit (%) einstellen",
	...
	it: {
		...
		probability_tag: "Imposta Probabilità di Vincita (%)",
	...
	vi: {
		...
		probability_tag: "Đặt Xác Suất Trúng (%)",
	...
	ru: {
		...
		reset_button: "Сброс",
		probability_tag: "Установите Вероятность Выигрыша (%)",
	...
	fr: {
		...
		reset_button: "reset",
		probability_tag: "Définir la Probabilité de Gagner (%)",
	...
	th: {
		...
		reset_button: "รีเซ็ต",
		probability_tag: "ตั้งค่าความน่าจะเป็นการชนะ (%)",
